...
export default function FloatingContact() {
  return (
    <>
      {/* WhatsApp — now on the left */}
      <div className="md:hidden fixed bottom-[calc(5.25rem+env(safe-area-inset-bottom))] left-5 z-50 flex flex-col items-center">
        <a
      ...
      {/* Call — now takes WhatsApp's former spot on the right */}
      <div className="md:hidden fixed bottom-[calc(5.25rem+env(safe-area-inset-bottom))] right-5 z-50 flex flex-col items-center">
        <a
          href="tel:+919324378802"
          aria-label="Call Swami Tours"
          className="fab-in flex h-14 w-14 items-center justify-center rounded-full bg-saffron text-white shadow-lg shadow-ink/25"
          style={{ animationDelay: "200ms" }}
        >
